# -*- coding: utf-8 -*-
"""
Created on Wed Jun 12 10:01:15 2019
...
#### test avec le changement de voie, route infinie avec 2 voies, avec 2 véhicules avec conducteurs humains

vehicles = {'vehicle':[1,2], 'classe vehicule':['HD','HD'],'type vehicule':['VL','VL'],'aggressivity 0':[50,90],'reaction time':[1,1], 'courtesy':[50,50], 'respect code de la route':[50,50], 'road': [1, 1], 'lane': [2, 2],'road turn':[3,3],'lane turn':[1,1], 'position turn':[1,1]}
